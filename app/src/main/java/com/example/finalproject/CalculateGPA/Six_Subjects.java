...
public class Six_Subjects extends Fragment {
    ...
    private EditText subject6EditText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_six__subjects, container, false);
        ...
        subject6EditText = view.findViewById(R.id.subject6EditText);
        ...
        calculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double subject6GPA = calculateGPA(subject6EditText.getText().toString());

                double totalGPA = ((subject1GPA + subject2GPA + subject3GPA + subject4GPA + subject5GPA + subject6GPA) * 3 )/18;
